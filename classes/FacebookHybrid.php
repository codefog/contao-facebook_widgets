...
/**
 * Parent class for Facebook objects that can be modules or content elements.
 */
abstract class FacebookHybrid extends \Frontend
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'facebook_default';
	...
	public function generate()
	{
		...
		if ($this->facebook_template != '')
		{
			$this->strTemplate = $this->facebook_template;
		}
